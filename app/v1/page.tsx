...
import { Loader2, ArrowLeft, Brain, Sparkles, BarChart3, Target, Zap } from "lucide-react"
...
export default function MonthlyFinanceAnalyzerV1() {
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2.5 flex items-center justify-between text-sm">
          <div className="flex items-center gap-2">
            <span className="bg-white/20 text-white text-xs font-semibold px-2 py-0.5 rounded-full">舊版</span>
            <span className="hidden sm:inline">您正在使用舊版介面</span>
          </div>
          <Link href="/">
            <Button size="sm" className="bg-white text-indigo-700 hover:bg-indigo-50 h-7 px-3 text-xs font-semibold gap-1.5">
        ...
        <div className="flex-1 container mx-auto px-4 py-6 sm:px-6 max-w-7xl flex items-center justify-center">
